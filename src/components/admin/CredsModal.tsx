    ...
    <Modal onClose={onClose}>
      ...
      <div className="px-[22px] py-[18px]">
        <div className="mb-1.5 rounded-[11px] bg-ink px-4 py-3.5">
          <div className="font-mono text-[11px] uppercase tracking-wide text-[#8B93A0]">Username</div>
        ...
        <div className="rounded-[11px] bg-ink px-4 py-3.5">
          <div className="font-mono text-[11px] uppercase tracking-wide text-[#8B93A0]">Password</div>
      ...
      <div className="flex justify-end px-[22px] pb-5">
        <button
          onClick={onClose}
          className="rounded-[9px] bg-ink px-4 py-2.5 font-display text-[13.5px] font-semibold text-white transition-colors hover:bg-black"
        >
          Done
        </button>
      </div>
